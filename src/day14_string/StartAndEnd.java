...
public class StartAndEnd {
    public static void main(String[] args) {
        ...
        String sentence = "Thursday is a java day.";
        ...
        System.out.println(sentence.endsWith("Thursday is a java day."));
        System.out.println(sentence.endsWith("hursday is a java day."));
        System.out.println(sentence.endsWith("TThursday is a java day."));
